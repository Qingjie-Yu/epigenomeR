...
find_two_valleys <- function(frags, dens_reso = 2^15, dens_kernel = "gaussian", 
                             valley1_range = c(73, 221), valley2_range = c(222, 368)) {
...
frag_hist <- function(frags_list, out_dir, BPPARAM, detect_valley = FALSE, 
                      dens_reso = 2^15, dens_kernel = "gaussian", 
                      valley1_range = c(73, 221), valley2_range = c(222, 368)) {
...
frag_decomposition <- function(file_path, out_dir, detect_valley = FALSE, 
                               dens_reso = 2^15, dens_kernel = "gaussian", 
                               valley1_range = c(73, 221), valley2_range = c(222, 368)) {
