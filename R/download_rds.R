...
download_rds <- function(rds_name, release_tag = "data-v1", force = TRUE) {
  sha256_list <- c(
    ...
    "GENCODE_v49_hg38.rds" = "",
    "GENCODE_v49_hg38_processed.rds" = "",
    ...
    "GENCODE_vM23_mm10_single_tx_by_evidence.rds" = "f3e8429e790420a877dd9df72f70dd0985ad4ed41a429076414fcb64ff9928d7","knownGene_hg38_processed.rds" = "",
    "knownGene_mm10_processed.rds" = "",
