...
#'
#' @param all_read_count_path Path to all_read_count.tsv generated by qc_count.sh
#' @param filtered_read_count_path Path to filtered_read_count.tsv generated by qc_count.sh
